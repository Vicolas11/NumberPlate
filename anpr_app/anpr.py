...
from anpr_app.apps import AnprAppConfig
...
def license_plate_recognition(plate_num_img):
    ...
    save_thresh = f'media/threshold/thre_{ts}.png'
    plt.savefig(save_thresh)

    classification_result = []
    for each_character in characters:
        # converts it to a 1D array
        each_character = each_character.reshape(1, -1);
        result = AnprAppConfig.model.predict(each_character)
    ...
    return rightplate_string, save_thresh
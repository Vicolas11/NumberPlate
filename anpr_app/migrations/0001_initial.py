# Generated by Django 4.0 on 2022-01-09 13:02

import anpr_app.manager
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entered', models.DateTimeField(max_length=10)),
                ('avatar', models.ImageField(default='default.png', upload_to=anpr_app.models.upload_to, verbose_name='Image')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            ...
            managers=[
                ('objects', anpr_app.manager.UserManager()),
            ],
        ),
    ]
